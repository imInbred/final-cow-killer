...
@ScriptManifest(name = "Self sufficient cow farmer", description = "get them levels up", author = "im inbred",
...
int[] cows={2790,2791,2793,2794};
    ...
    public void attackCow(){
        NPC victim = getNpcs().closest(npc -> npc != null && !npc.isInCombat() && npc.getName().equals("Cow")||npc.getName().equals("Calf"));
